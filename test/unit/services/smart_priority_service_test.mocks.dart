...
// in task_buddy/test/unit/services/smart_priority_service_test.dart.
...
class MockUserAnalyticsService extends _i1.Mock
    implements _i5.UserAnalyticsService {
  MockUserAnalyticsService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i6.UserAnalyticsModel? getAnalyticsForCategory(_i7.CategoryEnum? category) =>
      (super.noSuchMethod(Invocation.method(
        #getAnalyticsForCategory,
        [category],
      )) as _i6.UserAnalyticsModel?);
  ...
  @override
  Map<String, _i6.UserAnalyticsModel> getAllAnalytics() => (super.noSuchMethod(
        Invocation.method(
          #getAllAnalytics,
          [],
        ),
        returnValue: <String, _i6.UserAnalyticsModel>{},
      ) as Map<String, _i6.UserAnalyticsModel>);
